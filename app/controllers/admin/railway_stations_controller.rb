class Admin::RailwayStationsController < Admin::BaseController
  before_action :set_railway_station, only: [:show, :edit, :update, :destroy, :update_order]
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_railway_stations_url, notice: I18n.t('notices.railway_station_destroyed') }
  ...
  def update_order
    ...
    @railway_station.update_order(@route, params[:order])
